...
public class ResultController {
    ...
    public ResponseEntity<MicrobialTestResults> updateMicrobioTestResultData(
            @PathVariable Long sampleId,
            @RequestBody MicrobialTestDTO microbioTestDTO) {

        MicrobialTestResults updatedResult = resultService.updateMicrobialTestResultData(sampleId, microbioTestDTO);
        return ResponseEntity.ok(updatedResult);
    }
